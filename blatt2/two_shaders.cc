...
void createShaderProgram(Scene &scene) {
    ...
    const char* vertex_shader_source =
            ...
            "out vec3 ourColor;\n" //added this Pass color to fragment shader
            "void main(){\n"
...
void createTriangleScene(Scene &scene) {
    ...
    // color attribute
    glVertexAttribPointer(1, 3, GL_FLOAT, GL_FALSE, 6 * sizeof(float), (void*)(3 * sizeof(float))); //every color attribute start has 6 float length distance and has 3 float values offset(position values before color)
